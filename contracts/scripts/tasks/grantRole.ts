...
task("grant-role", "Grant a role")
  ...
  .setAction(async (taskArgs: { context: BytesLike; policyId: BytesLike; policyName: string }, hre) => {
    ...
    let policyInterface = new ethers.Interface(policy.abi);
    let fragment = policyInterface.getFunction("verifyTx");
    if (!fragment) {
      throw new Error("No fragment");
    }
    const args = AbiCoder.defaultAbiCoder().encode(fragment?.inputs, [
      {
        a: [
          "0x192d76d0534ee6501c64d5f1a3c9daf794488a1c59c6211ea95b02c2f4fe651c",
          "0x2a78ba2647a60ca3aef223ab258af4a021cc0f1d14f58f175970c23aee614e27",
        ],
        b: [
          [
        ...
        c: [
          "0x0c54ed11860320a9c0d0b02d12030f0a7d04e1ec2af2ef2c9ebf0165f792f47b",
          "0x0da7a93a3152b4e0c8dc5ffcb8e7674946fa9606838bdf795e40ece797a92f21",
        ],
      },
    ]);
